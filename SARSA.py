...
from src.V2.Functions.display import displayRGB
...
# random.seed(10)
# print(random.random())
# Q_sa = SARSA(environment, epoch_number = 3)
# optimal_policy = Policy.buildOptimalPolicyFrom(Q_sa)
# trained_agent = Agent(optimal_policy)
# run_static(environment, trained_agent, renderer = displayRGB)
