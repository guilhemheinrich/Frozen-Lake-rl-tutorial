...
def Q_learning(environment, epoch_number = 10000, epsilon = 0.1, alpha = 0.1, gamma = 0.99):
    ...
    for epoch in range(epoch_number):
        ...
        action = Qlearn_agent.pickNextAction(current_state)
        while not stop:
            '''
            ...
            Qlearn_agent.current_state_index = observation 
            Q_sa.update_Qlearning(current_state, next_action, observation, reward)
            action = next_action 
